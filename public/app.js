...
// // Clear offline patients after sync
...
//     await saveOffline(patient);
//     showToast('💾 No internet! Saved offline, will sync later.', 'yellow');
//   }
...
//     list.innerHTML = '<p class="text-gray-400 text-center">No patients found</p>';
//     return;
//   }
//   list.innerHTML = patients.map(p => `
//     <div class="bg-white rounded-xl p-4 shadow border-l-4 ${isOffline ? 'border-yellow-400' : 'border-green-400'}">
//       <div class="flex justify-between items-center">
//         <h3 class="font-bold text-gray-800 text-lg">${p.name}</h3>
//         <span class="text-xs px-2 py-1 rounded-full ${isOffline ? 'bg-yellow-100 text-yellow-700' : 'bg-green-100 text-green-700'}">
//           ${isOffline ? '💾 Offline' : '☁️ Synced'}
//         </span>
//       </div>
//       <p class="text-gray-500 text-sm">Age: ${p.age} | Phone: ${p.phone}</p>
//       <p class="text-gray-600 mt-1">Problem: ${p.problem}</p>
//       <p class="text-gray-600">Doctor: ${p.doctor}</p>
...
//   updateStatus();
//   showToast('🌐 Back online! Syncing data...', 'blue');
...
//   updateStatus();
//   showToast('📴 Gone offline! Data will be saved locally.', 'yellow');
// });
...
//     statusText.className = 'text-green-600 font-semibold text-sm';
//   } else {
//     indicator.className = 'w-3 h-3 rounded-full bg-yellow-400';
//     statusText.textContent = 'Offline';
//     statusText.className = 'text-yellow-600 font-semibold text-sm';
//   }
// }
...
//   toast.className = `fixed bottom-4 right-4 ${colors[color]} text-white px-6 py-3 rounded-xl shadow-lg z-50 transition-all`;
...
//     <html>
//     <head>
//       <title>Patient Slip - ${p.name}</title>
//       <style>
...
//         .status { background: #0ea5e9; color: white; padding: 4px 12px; border-radius: 20px; }
//         .footer { margin-top: 40px; text-align: center; color: #999; font-size: 12px; }
//         .prescription { background: #f0fdf4; border: 1px solid #86efac; padding: 15px; border-radius: 8px; margin-top: 20px; }
//       </style>
//     </head>
//     <body>
//       <h1>🏥 HealthCare Pro</h1>
//       <h2>Patient Appointment Slip</h2>
//       <div class="row"><span class="label">Patient Name:</span><span class="value">${p.name}</span></div>
//       <div class="row"><span class="label">Age:</span><span class="value">${p.age}</span></div>
//       <div class="row"><span class="label">Phone:</span><span class="value">${p.phone}</span></div>
//       <div class="row"><span class="label">Problem:</span><span class="value">${p.problem}</span></div>
//       <div class="row"><span class="label">Doctor:</span><span class="value">${p.doctor}</span></div>
...
//       <div class="row"><span class="label">Status:</span><span class="status">${p.status}</span></div>
//       ${p.prescription ? `<div class="prescription"><strong>💊 Prescription:</strong><br/>${p.prescription}</div>` : ''}
//       <div class="footer">Generated by HealthCare Pro | ${new Date().toLocaleDateString()}</div>
//     </body>
//     </html>
//   `);
//   win.document.close();
